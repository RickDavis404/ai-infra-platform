...
|---|---|---|---|
| `otel-collector/` | opentelemetry-collector | 0.165.0 | OTLP gateway (DaemonSet) |
| `prometheus/` | prometheus (standalone) | 29.18.0 | metrics (server + node-exporter + kube-state-metrics) |
| `alloy/` | alloy | 1.10.1 | otel-collector self-log shipper (DaemonSet) |
| `grafana/` | grafana | 12.7.3 | UI + datasources + dashboards |
| `loki/` | loki | 18.5.1 | logs (SimpleScalable on SeaweedFS S3) |
